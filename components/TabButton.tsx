...
export const TabButton: React.FC<TabButtonProps> = ({ icon: Icon, label, isActive, onClick }) => (
    <button
        onClick={onClick}
        className={`flex-shrink-0 md:flex-1 flex flex-col md:flex-row items-center justify-center py-2 px-3 md:px-4 md:py-4 md:border-b-2 text-sm font-medium transition-all active:scale-95 ${
            isActive

...
import { PlusIcon, TrashIcon, EditIcon, ChevronDownIcon, SearchIcon, ExclamationTriangleIcon, EnvelopeIcon } from './Icons';
                            ...
                            >
                                <div className="flex justify-between items-start gap-3">
                                    ...
                                    <div className="flex items-center shrink-0 -mr-2">
                                        <button onClick={() => onSendMessage(host)} className="p-2 text-gray-400 hover:text-primary dark:hover:text-primary-light rounded-full transition-colors active:scale-90" title="Envoyer un message"><EnvelopeIcon className="w-5 h-5"/></button>
